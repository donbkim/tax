...
- 기준 매도가 고정 결과와 집값 연 5% 복리 상승 가정 결과를 겹쳐 비교하는 Chart.js 음영 레이어
...
- **과세기준일 분기:** 종부세는 매년 6월 1일 보유자에게 부과되는 것으로 가정합니다. 2027~2029년 매도 시나리오는 6월 1일 전 매도(해당 연도 종부세 미부과)와 후 매도(해당 연도 종부세 포함)를 분리합니다.

### 3.4 시나리오별 총 소요비용 (Total Financial Burden)

- 총 소요비용: $\text{양도소득세} + \text{매도 해당 연도 종합부동산세} + \text{대출 이자 비용}$
...
- 슬라이더 조절 시 세분화된 9개 시나리오 세액 및 순이익 수치가 즉시 재계산되는가?
- 시나리오 4(2028년 거주 10년)가 최적안으로 강조 표시되는가?
- 부부 공동명의 과세표준 계산 시 인당 분산(50:50) 및 인당 공제 한도 로직이 정확히 작동하는가?
- 집값 연 5% 복리 상승 가정이 2026년 기준 매도가에서 계산되고, 양도세 재계산 결과가 기본 막대 뒤 회색 음영으로 표시되는가?
...
- 2026년 비거주 매도 및 2027~2029년 종부세 과세기준일(6월 1일) 전·후 매도를 포함한 9개 시나리오로 세분화
- 2028년 인당 20억 원, 2029년 이후 인당 10억 원 양도소득공제 한도의 실제 적용 여부를 비교표에 표시

### v1.3.0 (2026-09-02)

- 기준 매도가 고정 그래프 뒤에 2026년 기준 연 5% 집값 상승 및 그에 따른 양도세 재계산 결과를 회색 음영 막대로 표시

### v1.4.0 (2026-09-03)

- 종합부동산세를 이전 보유 연도와 합산하지 않고, 매도 해당 연도 6월 1일 이후 매도 시의 연간 세액만 총비용·비교표·차트에 반영
