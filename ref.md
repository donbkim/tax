...
현재 별도의 `handoff.md` 및 `update.md`는 없습니다. 작업 우선순위와 주요 변경사항이 생기면 해당 문서를 새로 만들고, 이 인덱스에서 참조해야 합니다.
...
2. `ref.md`
3. 현재 작업과 관련된 `src/` 파일
4. 필요 시 형제 프로젝트 `../group-trip-account-app-script/README.md`
...
### handoff.md / update.md (미작성)

`handoff.md`에는 현재 상태와 다음 작업 우선순위를, `update.md`에는 코드·세법·배포 변경 시 함께 갱신할 문서 목록을 기록합니다.
